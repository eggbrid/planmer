...
public abstract class BaseWeekView extends BaseView {
     ...
     */
    final void setup(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar) {
     ...
     */
    final void performClickCalendar(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, boolean isNotice) {
        ...
        com.kirito.planmer.calendar.view.widget.calendarview.Calendar currentCalendar = mItems.get(week);
     ...
     * @return 是否是最小访问边界了
     */
    final boolean isMinRangeEdge(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar) {
    ...
    final int getEdgeIndex(boolean isMinEdge) {
        for (int i = 0; i < mItems.size(); i++) {
            com.kirito.planmer.calendar.view.widget.calendarview.Calendar item = mItems.get(i);
    ...
    final void updateWeekStart() {
        ...
        com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar = CalendarUtil.getFirstCalendarStartWithMinCalendar(mDelegate.getMinYear(),
