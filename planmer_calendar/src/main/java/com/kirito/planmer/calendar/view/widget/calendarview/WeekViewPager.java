...
public final class WeekViewPager extends ViewPager {
    ...
    private void init() {
        mWeekCount = com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.getWeekCountBetweenBothCalendar(
        ...
        addOnPageChangeListener(new OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                com.kirito.planmer.calendar.view.widget.calendarview.BaseWeekView view = (com.kirito.planmer.calendar.view.widget.calendarview.BaseWeekView) findViewWithTag(position);
                if (view != null) {
     ...
     * @return 获取当前周数据
     */
    List<com.kirito.planmer.calendar.view.widget.calendarview.Calendar> getCurrentWeekCalendars() {
        List<com.kirito.planmer.calendar.view.widget.calendarview.Calendar> calendars = com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.getWeekCalendars(mDelegate.mIndexCalendar,
                mDelegate);
    ...
    void updateRange() {
        ...
        int i = com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.getWeekFromDayInMonth(calendar, mDelegate.getWeekStart());
    ...
    void scrollToCurrent(boolean smoothScroll) {
        isUsingScrollToCalendar = true;
        int position = com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.getWeekFromCalendarStartWithMinCalendar(mDelegate.getCurrentDay(),
                mDelegate.getMinYear(),
                mDelegate.getMinYearMonth(),
                mDelegate.getMinYearDay(),
        ...
        int i = com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.getWeekFromDayInMonth(mDelegate.getCurrentDay(), mDelegate.getWeekStart());
        mParentLayout.updateSelectWeek(i);
    }
     ...
     * 更新任意一个选择的日期
     */
    void updateSelected(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, boolean smoothScroll) {
        int position = com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.getWeekFromCalendarStartWithMinCalendar(calendar,
                mDelegate.getMinYear(),
                mDelegate.getMinYearMonth(),
                mDelegate.getMinYearDay(),
                mDelegate.getWeekStart()) - 1;
    ...
    void updateSingleSelect() {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            com.kirito.planmer.calendar.view.widget.calendarview.BaseWeekView view = (com.kirito.planmer.calendar.view.widget.calendarview.BaseWeekView) getChildAt(i);
    ...
    void updateDefaultSelect() {
        com.kirito.planmer.calendar.view.widget.calendarview.BaseWeekView view = (com.kirito.planmer.calendar.view.widget.calendarview.BaseWeekView) findViewWithTag(getCurrentItem());
        if (view != null) {
    ...
    private class WeekViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            Calendar calendar = com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.getFirstCalendarStartWithMinCalendar(mDelegate.getMinYear(),
                    mDelegate.getMinYearMonth(),
                    mDelegate.getMinYearDay(),
                    position + 1,
                    mDelegate.getWeekStart());
            com.kirito.planmer.calendar.view.widget.calendarview.BaseWeekView view;
            try {
                Constructor constructor = mDelegate.getWeekViewClass().getConstructor(Context.class);
                view = (com.kirito.planmer.calendar.view.widget.calendarview.BaseWeekView) constructor.newInstance(getContext());
            } catch (Exception e) {
                e.printStackTrace();
                return null;
            }
        ...
        public void destroyItem(ViewGroup container, int position, Object object) {
            com.kirito.planmer.calendar.view.widget.calendarview.BaseWeekView view = (BaseWeekView) object;
            if (view == null) {
                return;
            }
            view.onDestroy();
