...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.kirito.planmer.calendar.view.widget.calendarview.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.kirito.planmer.calendar.view.widget.calendarview.WeekBar".equalsIgnoreCase(getClass().getName())) {
