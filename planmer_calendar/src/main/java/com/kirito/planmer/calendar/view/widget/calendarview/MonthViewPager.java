...
import com.kirito.planmer.calendar.view.widget.calendarview.BaseMonthView;
import com.kirito.planmer.calendar.view.widget.calendarview.BaseView;
...
import com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil;
...
import com.kirito.planmer.calendar.view.widget.calendarview.WeekBar;
import com.kirito.planmer.calendar.view.widget.calendarview.WeekViewPager;
...
public final class MonthViewPager extends ViewPager {
    ...
    private void init() {
        ...
        addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar = com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.getFirstCalendarFromMonthViewPager(position, mDelegate);
                ...
                if (mDelegate.getSelectMode() == CalendarViewDelegate.SELECT_MODE_DEFAULT) {
                    if (!calendar.isCurrentMonth()) {
                        ...
                        mDelegate.mSelectedCalendar = com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.getRangeEdgeCalendar(calendar, mDelegate);
                    }
                ...
                com.kirito.planmer.calendar.view.widget.calendarview.BaseMonthView view = (com.kirito.planmer.calendar.view.widget.calendarview.BaseMonthView) findViewWithTag(position);
                if (view != null) {
    ...
    private void updateMonthViewHeight(int year, int month) {
        ...
        if (mParentLayout != null) {
            if (getVisibility() != VISIBLE) {//如果已经显示周视图，则需要动态改变月视图高度，否则显示就有bug
                ViewGroup.LayoutParams params = getLayoutParams();
                params.height = com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.getMonthViewHeight(year, month,
        ...
        mCurrentViewHeight = com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.getMonthViewHeight(year, month,
                mDelegate.getCalendarItemHeight(), mDelegate.getWeekStart(),
                mDelegate.getMonthViewShowMode());
        if (month == 1) {
            mPreViewHeight = com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.getMonthViewHeight(year - 1, 12,
                    mDelegate.getCalendarItemHeight(), mDelegate.getWeekStart(),
                    mDelegate.getMonthViewShowMode());
            mNextViewHeight = com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.getMonthViewHeight(year, 2,
                    mDelegate.getCalendarItemHeight(), mDelegate.getWeekStart(),
                    mDelegate.getMonthViewShowMode());
        } else {
            mPreViewHeight = com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.getMonthViewHeight(year, month - 1,
                    mDelegate.getCalendarItemHeight(), mDelegate.getWeekStart(),
                    mDelegate.getMonthViewShowMode());
            if (month == 12) {
                mNextViewHeight = com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.getMonthViewHeight(year + 1, 1,
                        mDelegate.getCalendarItemHeight(), mDelegate.getWeekStart(),
                        mDelegate.getMonthViewShowMode());
            } else {
                mNextViewHeight = com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.getMonthViewHeight(year, month + 1,
                        mDelegate.getCalendarItemHeight(), mDelegate.getWeekStart(),
                        mDelegate.getMonthViewShowMode());
            }
        }
    ...
    final void updateRange() {
        ...
        isUsingScrollToCalendar = false;
        com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar = mDelegate.mSelectedCalendar;
        ...
        if (mParentLayout != null) {
            int week = com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.getWeekFromDayInMonth(calendar, mDelegate.getWeekStart());
    ...
    List<Calendar> getCurrentMonthCalendars() {
        com.kirito.planmer.calendar.view.widget.calendarview.BaseMonthView view = (com.kirito.planmer.calendar.view.widget.calendarview.BaseMonthView) findViewWithTag(getCurrentItem());
        if (view == null) {
            return null;
        }
        return view.mItems;
    ...
    void updateSelected() {
        for (int i = 0; i < getChildCount(); i++) {
            com.kirito.planmer.calendar.view.widget.calendarview.BaseMonthView view = (com.kirito.planmer.calendar.view.widget.calendarview.BaseMonthView) getChildAt(i);
    ...
    void updateWeekStart() {
        ...
        setLayoutParams(params);
        if (mParentLayout != null) {
            int i = com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.getWeekFromDayInMonth(mDelegate.mSelectedCalendar, mDelegate.getWeekStart());
    ...
    private final class MonthViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            com.kirito.planmer.calendar.view.widget.calendarview.BaseMonthView view;
            try {
        ...
        public void destroyItem(ViewGroup container, int position, Object object) {
            com.kirito.planmer.calendar.view.widget.calendarview.BaseView view = (BaseView) object;
            if (view == null) {
                return;
            }
            view.onDestroy();
