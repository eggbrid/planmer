...
import com.kirito.planmer.calendar.view.widget.calendarview.CalendarViewDelegate;
import com.kirito.planmer.calendar.view.widget.calendarview.LunarCalendar;
...
final class CalendarUtil {
     ...
     */
    static boolean isWeekend(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar) {
     ...
     */
    static int getWeekFromDayInMonth(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, int weekStart) {
        java.util.Calendar date = java.util.Calendar.getInstance();
     ...
     * @return 获取上一个日子
     */
    static com.kirito.planmer.calendar.view.widget.calendarview.Calendar getPreCalendar(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar) {
        java.util.Calendar date = java.util.Calendar.getInstance();
        ...
        com.kirito.planmer.calendar.view.widget.calendarview.Calendar preCalendar = new com.kirito.planmer.calendar.view.widget.calendarview.Calendar();
    ...
    static com.kirito.planmer.calendar.view.widget.calendarview.Calendar getNextCalendar(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar) {
        java.util.Calendar date = java.util.Calendar.getInstance();
        ...
        com.kirito.planmer.calendar.view.widget.calendarview.Calendar nextCalendar = new com.kirito.planmer.calendar.view.widget.calendarview.Calendar();
     ...
     */
    static int getMonthViewStartDiff(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, int weekStart) {
        java.util.Calendar date = java.util.Calendar.getInstance();
        date.set(calendar.getYear(), calendar.getMonth() - 1, 1);
     ...
     * @return 返回某个日期是星期几
     */
    static int getWeekFormCalendar(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar) {
        java.util.Calendar date = java.util.Calendar.getInstance();
        date.set(calendar.getYear(), calendar.getMonth() - 1, calendar.getDay());
     ...
     */
    static int getWeekViewIndexFromCalendar(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, int weekStart) {
     ...
     * @return 是否在日期范围內
     */
    static boolean isCalendarInRange(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar,
     ...
     */
    static int getWeekFromCalendarStartWithMinCalendar(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar,
                                                       int minYear, int minYearMonth, int minYearDay,
                                                       int weekStart) {
        java.util.Calendar date = java.util.Calendar.getInstance();
     ...
     * @return 该星期的第一天日期
     */
    static com.kirito.planmer.calendar.view.widget.calendarview.Calendar getFirstCalendarStartWithMinCalendar(int minYear, int minYearMonth, int minYearDay, int week, int weekStart) {
        java.util.Calendar date = java.util.Calendar.getInstance();
     ...
     * @return 是否在日期范围内
     */
    static boolean isCalendarInRange(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, CalendarViewDelegate delegate) {
     ...
     */
    static int differ(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar1, com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar2) {
        if (calendar1 == null) {
    ...
    static int compareTo(int minYear, int minYearMonth, int minYearDay,
                         int maxYear, int maxYearMonth, int maxYearDay) {
        com.kirito.planmer.calendar.view.widget.calendarview.Calendar first = new com.kirito.planmer.calendar.view.widget.calendarview.Calendar();
        first.setYear(minYear);
        first.setMonth(minYearMonth);
        first.setDay(minYearDay);

        com.kirito.planmer.calendar.view.widget.calendarview.Calendar second = new com.kirito.planmer.calendar.view.widget.calendarview.Calendar();
     ...
     * @return 为月视图初始化日历项
     */
    static List<com.kirito.planmer.calendar.view.widget.calendarview.Calendar> initCalendarForMonthView(int year, int month, com.kirito.planmer.calendar.view.widget.calendarview.Calendar currentDate, int weekStar) {
        java.util.Calendar date = java.util.Calendar.getInstance();
        ...
        List<com.kirito.planmer.calendar.view.widget.calendarview.Calendar> mItems = new ArrayList<>();
        ...
        for (int i = 0; i < size; i++) {
            com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendarDate = new com.kirito.planmer.calendar.view.widget.calendarview.Calendar();
            if (i < mPreDiff) {
    ...
    static List<com.kirito.planmer.calendar.view.widget.calendarview.Calendar> getWeekCalendars(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, CalendarViewDelegate mDelegate) {
     ...
     * @return 生成周视图的7个item
     */
    static List<com.kirito.planmer.calendar.view.widget.calendarview.Calendar> initCalendarForWeekView(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, CalendarViewDelegate mDelegate, int weekStart) {
        ...
        com.kirito.planmer.calendar.view.widget.calendarview.Calendar selectCalendar = new com.kirito.planmer.calendar.view.widget.calendarview.Calendar();
     ...
     */
    static com.kirito.planmer.calendar.view.widget.calendarview.Calendar getFirstCalendarFromMonthViewPager(int position, CalendarViewDelegate delegate) {
        com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar = new com.kirito.planmer.calendar.view.widget.calendarview.Calendar();
     ...
     * @return 获取边界访问日期
     */
    static com.kirito.planmer.calendar.view.widget.calendarview.Calendar getRangeEdgeCalendar(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, CalendarViewDelegate delegate) {
        ...
        com.kirito.planmer.calendar.view.widget.calendarview.Calendar minRangeCalendar = delegate.getMinRangeCalendar();
