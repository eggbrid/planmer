...
public abstract class RangeMonthView extends BaseMonthView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mLineCount; i++) {
            for (int j = 0; j < 7; j++) {
                com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar = mItems.get(d);
     ...
     * @param j        j
     */
    private void draw(Canvas canvas, com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, int i, int j) {
     ...
     * @return 日历是否被选中
     */
    protected boolean isCalendarSelected(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar) {
    ...
    public void onClick(View v) {
        ...
        com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar = getIndex();
        ...
        if (mDelegate.mSelectedStartRangeCalendar != null && mDelegate.mSelectedEndRangeCalendar == null) {
            int minDiffer = com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.differ(calendar, mDelegate.mSelectedStartRangeCalendar);
            if (minDiffer >= 0 && mDelegate.getMinSelectRange() != -1 && mDelegate.getMinSelectRange() > minDiffer + 1) {
                ...
                return;
                    ...
                    com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.differ(calendar, mDelegate.mSelectedStartRangeCalendar) + 1) {
                if (mDelegate.mCalendarRangeSelectListener != null) {
        ...
        if (mParentLayout != null) {
            if (calendar.isCurrentMonth()) {
                ...
                mParentLayout.updateSelectWeek(com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.getWeekFromDayInMonth(calendar, mDelegate.getWeekStart()));
            }
        }
        if (mDelegate.mCalendarRangeSelectListener != null) {
     ...
     * @return 上一个日期是否选中
     */
    protected final boolean isSelectPreCalendar(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar) {
        com.kirito.planmer.calendar.view.widget.calendarview.Calendar preCalendar = com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.getPreCalendar(calendar);
     ...
     * @return 下一个日期是否选中
     */
    protected final boolean isSelectNextCalendar(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar) {
        com.kirito.planmer.calendar.view.widget.calendarview.Calendar nextCalendar = com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.getNextCalendar(calendar);
     ...
     */
    protected abstract boolean onDrawSelected(Canvas canvas, com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, int x, int y, boolean hasScheme,
     ...
     */
    protected abstract void onDrawScheme(Canvas canvas, com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, int x, int y, boolean isSelected);
