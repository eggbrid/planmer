...
public abstract class YearView extends View {
     ...
     * 日历项
     */
    List<com.kirito.planmer.calendar.view.widget.calendarview.Calendar> mItems;
    ...
    private void addSchemesFromMap() {
        ...
        for (com.kirito.planmer.calendar.view.widget.calendarview.Calendar a : mItems) {
            if (mDelegate.mSchemeDatesMap.containsKey(a.toString())) {
                com.kirito.planmer.calendar.view.widget.calendarview.Calendar d = mDelegate.mSchemeDatesMap.get(a.toString());
     ...
     * @param d        d
     */
    private void draw(Canvas canvas, com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, int i, int j, int d) {
     ...
     * @param y        日历Card y起点坐标
     */
    protected abstract void onDrawScheme(Canvas canvas, com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, int x, int y);
