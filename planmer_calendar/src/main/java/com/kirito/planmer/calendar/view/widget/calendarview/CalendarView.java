...
public class CalendarView extends FrameLayout {
     ...
     * 星期栏
     */
    private com.kirito.planmer.calendar.view.widget.calendarview.WeekBar mWeekBar;
    ...
    private void init(Context context) {
        ...
        try {
            ...
            mWeekBar = (com.kirito.planmer.calendar.view.widget.calendarview.WeekBar) constructor.newInstance(getContext());
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        params.setMargins(0, mDelegate.getWeekBarHeight() + com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.dipToPx(context, 1), 0, 0);
        ...
        mDelegate.mInnerListener = new OnInnerDateSelectedListener() {
             ...
             */
            @Override
            public void onMonthDateSelected(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, boolean isClick) {
             ...
             */
            @Override
            public void onWeekDateSelected(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, boolean isClick) {
                mDelegate.mIndexCalendar = calendar;
                if (mDelegate.getSelectMode() == CalendarViewDelegate.SELECT_MODE_DEFAULT || isClick
        ...
        if (mDelegate.getSelectMode() == CalendarViewDelegate.SELECT_MODE_DEFAULT) {
            ...
            mDelegate.mSelectedCalendar = new com.kirito.planmer.calendar.view.widget.calendarview.Calendar();
        }
    ...
    public void setRange(int minYear, int minYearMonth, int minYearDay,
        ...
        if (com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.compareTo(minYear, minYearMonth, minYearDay,
    ...
    public void scrollToCurrent(boolean smoothScroll) {
        ...
        com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar = mDelegate.createCurrentDate();
    ...
    public void scrollToCalendar(int year, int month, int day, boolean smoothScroll) {
        ...
        com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar = new com.kirito.planmer.calendar.view.widget.calendarview.Calendar();
     ...
     */
    public final void putMultiSelect(com.kirito.planmer.calendar.view.widget.calendarview.Calendar... calendars) {
        if (calendars == null || calendars.length == 0) {
            return;
        }
        for (com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar : calendars) {
     ...
     * @param calendars calendars
     */
    public final void removeMultiSelect(com.kirito.planmer.calendar.view.widget.calendarview.Calendar... calendars) {
        if (calendars == null || calendars.length == 0) {
            return;
        }
        for (com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar : calendars) {
    ...
    public final List<com.kirito.planmer.calendar.view.widget.calendarview.Calendar> getMultiSelectCalendars() {
        List<com.kirito.planmer.calendar.view.widget.calendarview.Calendar> calendars = new ArrayList<>();
     ...
     * @return return
     */
    public final List<com.kirito.planmer.calendar.view.widget.calendarview.Calendar> getSelectCalendarRange() {
    ...
    public final void setSelectStartCalendar(int startYear, int startMonth, int startDay) {
        ...
        com.kirito.planmer.calendar.view.widget.calendarview.Calendar startCalendar = new com.kirito.planmer.calendar.view.widget.calendarview.Calendar();
    ...
    public final void setSelectStartCalendar(com.kirito.planmer.calendar.view.widget.calendarview.Calendar startCalendar) {
        if (mDelegate.getSelectMode() != CalendarViewDelegate.SELECT_MODE_RANGE) {
            return;
        }
    ...
    public final void setSelectEndCalendar(int endYear, int endMonth, int endDay) {
        ...
        com.kirito.planmer.calendar.view.widget.calendarview.Calendar endCalendar = new com.kirito.planmer.calendar.view.widget.calendarview.Calendar();
    ...
    public final void setSelectEndCalendar(com.kirito.planmer.calendar.view.widget.calendarview.Calendar endCalendar) {
        if (mDelegate.getSelectMode() != CalendarViewDelegate.SELECT_MODE_RANGE) {
            return;
        }
        if (mDelegate.mSelectedStartRangeCalendar == null) {
     ...
     */
    public final void setSelectCalendarRange(com.kirito.planmer.calendar.view.widget.calendarview.Calendar startCalendar, com.kirito.planmer.calendar.view.widget.calendarview.Calendar endCalendar) {
        if (mDelegate.getSelectMode() != CalendarViewDelegate.SELECT_MODE_RANGE) {
            return;
        }
     ...
     * @return 是否拦截日期
     */
    protected final boolean onCalendarIntercept(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar) {
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        mDelegate.mSelectedCalendar = (com.kirito.planmer.calendar.view.widget.calendarview.Calendar) bundle.getSerializable("selected_calendar");
        mDelegate.mIndexCalendar = (com.kirito.planmer.calendar.view.widget.calendarview.Calendar) bundle.getSerializable("index_calendar");
        if (mDelegate.mCalendarSelectListener != null) {
            mDelegate.mCalendarSelectListener.onCalendarSelect(mDelegate.mSelectedCalendar, false);
        }
     ...
     */
    public final void setSchemeDate(Map<String, com.kirito.planmer.calendar.view.widget.calendarview.Calendar> mSchemeDates) {
     ...
     * @param calendar calendar
     */
    public final void addSchemeDate(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar) {
     ...
     */
    public final void addSchemeDate(Map<String, com.kirito.planmer.calendar.view.widget.calendarview.Calendar> mSchemeDates) {
     ...
     * @param calendar calendar
     */
    public final void removeSchemeDate(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar) {
        if (calendar == null) {
            return;
        }
     ...
     * @return 获取当前周数据
     */
    public List<com.kirito.planmer.calendar.view.widget.calendarview.Calendar> getCurrentWeekCalendars() {
     ...
     * @return return
     */
    public List<com.kirito.planmer.calendar.view.widget.calendarview.Calendar> getCurrentMonthCalendars() {
     ...
     * @return 获取选择的日期
     */
    public com.kirito.planmer.calendar.view.widget.calendarview.Calendar getSelectedCalendar() {
     ...
     * @return 最小范围日期
     */
    public com.kirito.planmer.calendar.view.widget.calendarview.Calendar getMinRangeCalendar() {
     ...
     * @return 最大范围日期
     */
    public com.kirito.planmer.calendar.view.widget.calendarview.Calendar getMaxRangeCalendar() {
     ...
     * @return 是否在日期范围内
     */
    protected final boolean isInRange(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar) {
        return mDelegate != null && com.kirito.planmer.calendar.view.widget.calendarview.CalendarUtil.isCalendarInRange(calendar, mDelegate);
    }
    ...
    public interface OnWeekChangeListener {
        void onWeekChange(List<com.kirito.planmer.calendar.view.widget.calendarview.Calendar> weekCalendars);
    }
    ...
    interface OnInnerDateSelectedListener {
         ...
         * @param isClick  是否是点击
         */
        void onMonthDateSelected(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, boolean isClick);
         ...
         * @param isClick  是否是点击
         */
        void onWeekDateSelected(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, boolean isClick);
    }
    ...
    public interface OnCalendarRangeSelectListener {
         ...
         * @param calendar calendar
         */
        void onCalendarSelectOutOfRange(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar);
         ...
         */
        void onSelectOutOfRange(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, boolean isOutOfMinRange);
         ...
         * @param isEnd    是否结束
         */
        void onCalendarRangeSelect(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, boolean isEnd);
    }
    ...
    public interface OnCalendarMultiSelectListener {
         ...
         * @param calendar calendar
         */
        void onCalendarMultiSelectOutOfRange(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar);
         ...
         * @param calendar calendar
         */
        void onMultiSelectOutOfSize(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, int maxSize);
         ...
         */
        void onCalendarMultiSelect(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, int curSize, int maxSize);
    }
    ...
    public interface OnCalendarSelectListener {
         ...
         * @param calendar calendar
         */
        void onCalendarOutOfRange(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar);
         ...
         */
        void onCalendarSelect(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, boolean isClick);
    }
    ...
    public interface OnCalendarLongClickListener {
         ...
         * @param calendar calendar
         */
        void onCalendarLongClickOutOfRange(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar);
         ...
         * @param calendar calendar
         */
        void onCalendarLongClick(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar);
    }
    ...
    public interface OnCalendarInterceptListener {
        boolean onCalendarIntercept(com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar);
