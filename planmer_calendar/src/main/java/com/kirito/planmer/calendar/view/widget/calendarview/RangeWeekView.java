...
import com.kirito.planmer.calendar.view.widget.calendarview.BaseWeekView;
...
public abstract class RangeWeekView extends BaseWeekView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            onLoopStart(x);
            com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar = mItems.get(i);
     ...
     */
    protected abstract boolean onDrawSelected(Canvas canvas, com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, int x, boolean hasScheme,
     ...
     */
    protected abstract void onDrawScheme(Canvas canvas, com.kirito.planmer.calendar.view.widget.calendarview.Calendar calendar, int x, boolean isSelected);
