...
public class EarthMapRenderer implements GLSurfaceView.Renderer {
    public EarthMapRenderer(Context context) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        //编译顶点着色程序
        String vertexShaderStr = ResReadUtils.readResource(context, R.raw.vertex_earth_shader);
        int vertexShaderId = ShaderUtils.compileVertexShader(vertexShaderStr);
        //编译片段着色程序
        String fragmentShaderStr = ResReadUtils.readResource(context, R.raw.fragment_earth_shader);
